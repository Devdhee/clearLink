...
function Faqs() {
  ...
  return (
    <div className="flex max-w-[1450px] px-10 mx-auto py-[96px] justify-between gap-4 lg:flex-col sm:px-4">
      <div className="flex flex-col max-w-[547px]">
        <p className="text-[#175CD3] text-lg font-semibold mb-3 lg:mb-2 md:mb-1">
          Support
        </p>
        <h4 className="text-[#1D2939] text-5xl font-semibold mb-5 lg:text-4xl md:text-3xl sm:text-2xl lg:mb-3 md:mb-2">
          FAQs
        </h4>
        <p className="text-[#667085] text-2xl lg:text-xl md:text-lg sm:text-base">
